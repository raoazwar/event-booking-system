...
<body>
    <div class="email-container">
        <div class="header">
            ...
            <div class="stripe-badge">Powered by Stripe</div>
            <div class="success-icon">🎉</div>
            <h1 style="color: #28a745; margin: 0;">Payment Successful!</h1>
            <p style="color: #666; margin: 10px 0 0 0;">Your payment has been processed securely via Stripe</p>
        </div>

        <p>Dear <strong>{{ $customerName }}</strong>,</p>
        
        <p>Thank you for your payment! Your booking has been confirmed and your tickets are secure. Your payment was processed securely through Stripe.</p>

        <div class="event-details">
            <h3 style="margin-top: 0; color: #6772e5;">Event Details</h3>
        ...
        <div class="booking-summary">
            ...
            <p><strong>Payment Method:</strong> Credit/Debit Card (Stripe)</p>
        ...
        <p>Your payment was processed securely through Stripe, a PCI Service Provider Level 1 certified payment processor. Your card information is never stored on our servers.</p>
